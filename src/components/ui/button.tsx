...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/50 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gold text-black hover:bg-gold-light shadow-lg shadow-gold/10 hover:shadow-gold/20",
        secondary:
          "bg-white/[0.06] text-white border border-white/[0.06] hover:bg-white/[0.1] hover:border-white/[0.12]",
        ghost: "text-white/70 hover:text-white hover:bg-white/[0.06]",
        outline:
          "border border-white/[0.06] bg-transparent text-white hover:bg-white/[0.06]",
