...
export function OpportunityCard({ opportunity, index, onLaunch }: OpportunityCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-white/[0.06] bg-card crest-card-lift transition-all duration-500 hover:border-white/[0.12] hover:shadow-2xl hover:shadow-black/40"
    >
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 crest-metric-panel p-3">
        ...
        <div className="rounded-xl border border-gold/15 bg-gold/[0.05] px-3 py-2 crest-proof-panel">
